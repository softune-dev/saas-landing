...
export default function ArticlePage({
  ...
  const blogIndexHref = isBn ? "/bn/blog" : "/blog";
      ...
      <main className="min-h-screen bg-[var(--color-canvas)]">
        ...
        >
          ...
          <div className="absolute top-6 left-6 flex items-center gap-2">
            <a href={blogIndexHref} className="text-white/70 text-[13px] font-semibold hover:text-white transition-colors">
              {isBn ? "ব্লগ" : "Blog"}
            </a>
              ...
              <div className="mt-10 flex md:hidden items-center justify-between p-5 rounded-[20px] bg-[var(--color-surface)] border border-[var(--color-line)]">
                <div>
                  <p className="text-[15px] font-extrabold text-[var(--color-ink)]">
                    {isBn ? "নিবন্ধটি কেমন লাগলো?" : "Enjoyed this article?"}
                  </p>
                  <p className="text-[13px] text-[var(--color-muted)] font-medium mt-0.5">
                    {isBn ? "অন্যদের সাথে শেয়ার করুন" : "Share it with your network"}
                  </p>
                </div>
                <button
              ...
              <div className="sticky top-28 space-y-4">
                ...
                <div className="rounded-[12px] border border-[var(--color-line)] bg-[var(--color-surface)] overflow-hidden">
                  <div className="flex items-center gap-2 px-4 py-3 border-b border-[var(--color-line)] bg-[var(--color-canvas)]">
                    <div className="size-2 rounded-full bg-[var(--color-brand)]" />
                    <p className="text-[13px] font-bold text-[var(--color-ink)]">
                      {isBn ? "নিবন্ধের তথ্য" : "Article Details"}
                    </p>
                  </div>
        ...
        <section className="py-20 border-t border-[var(--color-line)] max-w-6xl mx-auto px-5 md:px-8">
          <h2 className="text-2xl font-extrabold tracking-tight text-[var(--color-ink)] mb-10" style={{ fontFamily: "var(--font-heading)" }}>
            {isBn ? "সম্পর্কিত নিবন্ধসমূহ" : "Related Articles"}
          </h2>
