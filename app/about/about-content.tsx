...
const timelineBn = [
  ...
  {
    year: "2025",
    title: "ফাউন্ডেশন তৈরি",
    desc: "আইসোলেটেড মার্চেন্ট ডেটা আর্কিটেকচার, লাইভ থিম এডিটর এবং শক্তিশালী স্টোরফ্রন্ট ইন্টিগ্রেশন সম্পন্ন করা হয়।",
    icon: "/icons/splash.svg",
  },
  {
    year: "2026",
    title: "লাইভ লঞ্চ",
    desc: "ড্যাশবোর্ড, স্টোরফ্রন্ট থিমসমূহ, Gemini AI টুলস, লোকাল পেমেন্ট (bKash, Nagad, SSLCommerz), কুরিয়ার কানেক্ট, POS এবং রিয়েল-টাইম Analytics সম্পন্ন করে প্ল্যাটফর্ম লাইভ হয়।",
    icon: "/icons/analytics.svg",
  },
];

export default function AboutPage({ locale = "en" }: { locale?: "en" | "bn" }) {
  const isBn = locale === "bn";
  const timeline = isBn ? timelineBn : timelineEn;
  const signupHref = isBn ? "/bn/signup" : "/signup";
  const contactHref = isBn ? "/bn/support/contact" : "/support/contact";
            ...
            {isBn ? (
              <>
                ...
                <span className="relative inline-block px-3 py-1 mx-1">
                  ...
                  <em className="relative not-italic text-white">সহজ সমাধান</em>
                </span>
              </>
            ) : (
              <>
          ...
          <div className="mx-auto grid max-w-6xl grid-cols-1 gap-x-16 gap-y-14 text-left md:grid-cols-2">
            ...
            <div>
              <h3
                ...
                style={{ fontFamily: "var(--font-heading), var(--font-bn)" }}
              >
                {isBn ? "কাদের জন্য আমরা তৈরি করেছি" : "Who we build for"}
              </h3>
              <p className="mt-5 text-[16px] font-medium leading-relaxed text-[var(--color-muted)] md:text-lg">
                {isBn
                  ? "আমরা স্বাধীন মার্চেন্টদের জন্য কাজ করি। কম্পিউটার সায়েন্সে ডিগ্রি না থাকলেও যে কেউ থিম বেছে নিয়ে, প্রোডাক্ট অ্যাড করে এবং bKash, Nagad বা SSLCommerz অন করে স্টোর লাইভ করতে পারেন।"
            ...
            <div>
              <h3
                ...
                style={{ fontFamily: "var(--font-heading), var(--font-bn)" }}
              >
                {isBn ? "প্ল্যাটফর্মে কী কী থাকছে" : "What the platform covers"}
              </h3>
              <p className="mt-5 text-[16px] font-medium leading-relaxed text-[var(--color-muted)] md:text-lg">
                {isBn
        ...
        <section className="py-24 border-y border-[var(--color-line)] bg-[var(--color-canvas)]/40 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-5 md:px-8">
            <div className="text-center mb-16">
              <h2
                className="text-3xl font-extrabold tracking-tight text-[var(--color-ink)] md:text-5xl"
                style={{ fontFamily: "var(--font-heading), var(--font-bn)" }}
              >
                {isBn ? "আমাদের " : "Our "}
                  ...
                  >
                    <div className="absolute -left-[48px] md:-left-[60px] top-1 flex size-8 md:size-10 items-center justify-center rounded-full bg-[var(--color-brand)] text-white ring-8 ring-[var(--color-canvas)] transition-transform group-hover:scale-110 shadow-sm">
                      <img
                        src={step.icon}
                        alt=""
                        className="size-4 md:size-5 object-contain brightness-0 invert"
                      />
                    </div>
                    <div>
            ...
            {team.map((member) => (
              ...
              >
                ...
                <div className="relative z-10 flex flex-col flex-1 p-8 md:p-10">
                  ...
                  <h3
                    className="mt-2 text-2xl md:text-3xl font-bold tracking-tight text-[var(--color-ink)] leading-snug"
                    style={{ fontFamily: "var(--font-heading), var(--font-bn)" }}
                  >
                    {member.name}
                  </h3>
        ...
        <section className="pt-24 pb-24 max-w-7xl mx-auto px-5 md:px-8">
          ...
          >
            ...
            <div className="relative z-10 max-w-2xl mx-auto">
              <h3
                className="text-2xl md:text-3xl font-extrabold text-[var(--color-ink)] mb-4"
                style={{ fontFamily: "var(--font-heading), var(--font-bn)" }}
              >
                {isBn ? "আজই আপনার ব্র্যান্ড গ্রো করুন" : "Scale Your Brand With Us"}
              </h3>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button variant="primary" as="a" href={signupHref} className="px-8 py-3.5 font-bold gap-2">
                  {isBn ? "ফ্রি ট্রায়াল" : "Start Free"}
                  <img src="/icons/arrow-right.svg" alt="" className="size-4 object-contain brightness-0 invert" />
                </Button>
                <Button variant="secondary" as="a" href={contactHref} className="px-8 py-3.5 font-bold">
                  {isBn ? "কন্টাক্ট করুন" : "Contact Support"}
                </Button>
              </div>
            </div>
          </motion.div>
