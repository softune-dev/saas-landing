...
const cookieSections = [
  {
    ...
    content: "Cookies are small textual data fragments transmitted to your device browser. They allow our systems to recognize your local storefront configuration preferences, active sessions, and shopping cart states."
  },
  {
  ...
  },
  {
    ...
    content: "Essential Cookies: Necessary to log in to dashboard and store credentials securely. Analytical Cookies: Assist our engineers in monitoring page speed loads. Functional Cookies: Remember your multi-currency or localized settings."
  },
  {
    title: "How to Manage Cookies",
    content: "You can configure your browser to block or alert you about cookies. Note that disabling essential cookies may impact checkout workflows, backend dashboard access, and visual editor rendering."
  }
];
        ...
        <div className="relative pt-12 pb-14 px-5 text-center overflow-hidden bg-[var(--color-canvas)] rounded-b-[4rem] border-b-[6px] border-[var(--color-surface)] shadow-[0_30px_60px_-15px_rgba(0,0,0,0.08)]">
          ...
          >
            <div className="relative flex size-6 items-center justify-center rounded-full bg-[var(--color-brand)]/10">
              ...
              <Cookie className="size-3.5 text-[var(--color-brand)]" />
            </div>
          ...
          >
            We care about your web experience. Understand what tracking elements we load and how you can fully control your cookie preferences.
          </motion.p>
        </div>
            ...
            <div className="relative z-10 space-y-10">
              <div className="border-b border-[var(--color-line)] pb-6">
                ...
                <p className="text-[15.5px] leading-relaxed text-[var(--color-muted)] font-medium">
                  We use cookies and telemetry identifiers to analyze user behaviors and design professional dashboard storefront interfaces.
                </p>
              </div>

              {cookieSections.map((sec, i) => (
