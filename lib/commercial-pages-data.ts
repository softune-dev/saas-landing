...
> = {
  "ecommerce-platform-bangladesh": {
    ...
    intro:
      "Softune is a full ecommerce platform designed around how Bangladeshi merchants actually sell — local payment methods, real courier partners, and no code required.",
    features: [
  ...
  "online-store-builder-bangladesh": {
    ...
    intro:
      "Softune's store builder lets you design, launch, and run a real online store in Bangladesh — visual editing, local payments, and courier delivery, no developer required.",
    features: [
  ...
  "shopify-alternative-bangladesh": {
    ...
    h1Highlight: "Bangladesh",
    intro:
      "Shopify is a strong global platform, but it wasn't built around Bangladeshi payment methods and couriers. Softune was — bKash, Nagad, SSLCommerz, and local delivery partners are native, not third-party workarounds.",
    features: [
  ...
  "woocommerce-alternative-bangladesh": {
    ...
    description:
      "Looking for a WooCommerce alternative in Bangladesh? Softune is a fully hosted platform with built-in bKash, Nagad, SSLCommerz, and local courier integrations — no separate hosting or plugin maintenance.",
    pill: "WooCommerce Alternative",
    h1Start: "A WooCommerce Alternative for",
    h1Highlight: "Bangladesh",
    intro:
      "WooCommerce means running your own WordPress hosting, security updates, and a stack of plugins. Softune is fully hosted, with local payments and couriers built in from the start.",
    features: [
  ...
  "best-ecommerce-platform-bangladesh": {
    ...
    description:
      "What makes an ecommerce platform right for Bangladesh: native BDT pricing, bKash/Nagad/SSLCommerz payments, real courier integrations, and Cash on Delivery. See how Softune covers all of it.",
    pill: "Ecommerce Platform Bangladesh",
    h1Start: "What Makes an Ecommerce Platform Right for",
    h1Highlight: "Bangladesh",
    intro:
      "A platform built for a global market doesn't always fit Bangladeshi ecommerce. Here's what actually matters for merchants here — and how Softune covers it, feature by feature.",
    features: [
  ...
  "fcommerce-website-bangladesh": {
    ...
    description:
      "Selling on a Facebook Page in Bangladesh? Build a real ecommerce website with Softune — COD, bKash, Nagad, courier delivery, and a proper product catalog beyond comments and DMs.",
    pill: "F-commerce to Website",
    h1Start: "Turn Your Facebook Page Into a Real",
    h1Highlight: "Website",
    intro:
      "Selling through Facebook comments and inbox messages doesn't scale. Softune gives F-commerce sellers a real storefront — product catalog, local payments, and courier delivery — while keeping the Facebook Page as a marketing channel.",
    features: [
