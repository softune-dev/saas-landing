...
export const FEATURE_PAGES_BN: Record<string, FeatureData> = {
  ...
  "events-campaigns": {
    slug: "events-campaigns",
    pillText: "ইভেন্ট ও ক্যাম্পেইন",
    titleStart: "সেল চালান",
    ...
    alternating: [
      {
        ...
        titleEnd: "",
        description:
          "ক্যাম্পেইনের নাম, বিবরণ ও ব্যানার ছবি দিন, তারপর চেকআউটে প্রযোজ্য পার্সেন্ট ডিসকাউন্ট সেট করুন।",
        bullets: [
          "ক্যাম্পেইনের নাম, বিবরণ ও ব্যানার ছবি",
          "প্রতি ক্যাম্পেইনে একটি পার্সেন্ট ডিসকাউন্ট",
          "যেকোনো সময় ক্যাম্পেইন চালু বা বন্ধ করুন",
          "চালু থাকলে স্টোরফ্রন্টের Events সেকশনে দেখা যাবে",
        ],
      },
      {
        pillText: "নির্দিষ্ট প্রোডাক্ট",
        pillIcon: "/icons/shop-bag.svg",
        titleStart: "কোন প্রোডাক্টে",
        titleHighlight: "প্রযোজ্য বেছে নিন",
        titleEnd: "",
        description:
          "পুরো ক্যাটালগ নয়, নির্দিষ্ট প্রোডাক্টে ক্যাম্পেইন বাঁধুন। একটি প্রোডাক্ট একসাথে শুধু একটি একটিভ ক্যাম্পেইনে থাকতে পারে, তাই দামে কোনো কনফ্লিক্ট হয় না।",
        bullets: [
          "সেলে কোন প্রোডাক্ট থাকবে বেছে নিন",
          "একটি প্রোডাক্ট একসাথে একটি একটিভ ক্যাম্পেইনে থাকে",
          "ভুলে দুইবার ডিসকাউন্ট হওয়ার সুযোগ নেই",
          "ক্যাম্পেইন চলাকালীন প্রোডাক্ট যোগ বা সরানো যায়",
        ],
      },
      {
        pillText: "চেকআউটে কার্যকর",
        pillIcon: "/icons/wallet.svg",
        titleStart: "আসল ডিসকাউন্ট,",
        ...
        bullets: [
          ...
          "সেল শেষ হলে ম্যানুয়ালি দাম ফেরত দিতে হয় না",
          "অর্ডার হিস্ট্রিতে কেনার সময়কার সেল প্রাইসই থেকে যায়",
        ],
      },
    ],
