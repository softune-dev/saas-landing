...
export const sectionsEn: FeatureSection[] = [
  ...
  },
  {
    ...
    pillIcon: "/icons/ai.svg",
    titleStart: "Create Photos & Graphics,",
    ...
    bullets: [
      ...
      "Runs on a simple, flexible credit system",
    ],
    showcase: "ai-image",
...
export const sectionsBn: FeatureSection[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "সরাসরি অর্ডার স্ট্যাটাস আপডেট ও সেল ইভেন্ট তৈরি করুন",
      "ইনস্ট্যান্ট কাস্টমার রেকর্ড ও স্টোর ডেটা খুঁজে বের করার সুবিধা",
    ],
    showcase: "chat",
  },
  {
  ...
  },
  {
    ...
    pillIcon: "/icons/ai.svg",
    titleStart: "ছবি ও গ্রাফিক্স তৈরি করুন,",
    titleHighlight: "কয়েক সেকেন্ডে",
    titleEnd: "",
    description:
    ...
    bullets: [
      ...
      "সহজ ও ফ্লেক্সিবল ক্রেডিট সিস্টেমের মাধ্যমে চালিত",
    ],
    showcase: "ai-image",
    placeholderColor: "#1e1b4b",
  },
