 ...
 * left-to-right as the page scrolls — plus a small glowing dot riding the
...
export function ScrollProgress() {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 top-0 z-[60] h-[3px]">
      ...
      />
      <motion.div
        className="absolute top-1/2 size-2.5 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[var(--color-brand)] shadow-[0_0_10px_3px_var(--color-brand)]"
        style={{ left: tipLeft }}
